...
0001   0000 18 67       L0032:  JR L0001
...
0096   0069 31 00 62    L0001:  LD SP,6200H
0097   006C AF                  XOR A
0098   006D CD 64 01            CALL L0004
0099   0070 3E 7C               LD A,7CH
0100   0072 D3 88               OUT (88H),A
0101   0074 21 59 01            LD HL,0159H
0102   0077 46                  LD B,(HL)
0103   0078 23          L0006:  INC HL
0104   0079 7E                  LD A,(HL)
0105   007A CD 65 10            CALL L0005
0106   007D 10 F9               DJNZ L0006
0107   007F 11 13 01            LD DE,0113H
0108   0082 CD D5 0F            CALL L0007
0109   0085 AF                  XOR A
0110   0086 D3 8C               OUT (8CH),A
0111   0088 D3 90               OUT (90H),A
0112   008A 3D                  DEC A
0113   008B 21 00 00            LD HL,0000H
0114   008E 01 00 00            LD BC,0000H
0115   0091 00          L0008:  NOP
0116   0092 23                  INC HL
0117   0093 10 FC               DJNZ L0008
0118   0095 0D                  DEC C
0119   0096 20 F9               JR NZ,L0008
0120   0098 D3 8C               OUT (8CH),A
0121   009A D3 90               OUT (90H),A
0122   009C 21 5D 01            LD HL,015DH
0123   009F 01 51 07            LD BC,0751H
0124   00A2 ED B3               OTIR
0125   00A4 3E 7C               LD A,7CH
0126   00A6 32 79 61            LD (6179H),A
0127   00A9 ED 5E               IM 2
0128   00AB 3E 60               LD A,60H
0129   00AD 32 7A 61            LD (617AH),A
0130   00B0 21 FC 00    L0015:  LD HL,00FCH
0131   00B3 CD 9F 01            CALL L0009
0132   00B6 CD AE 01            CALL L0010
0133   00B9 DB 58               IN A,(58H)
0134   00BB E6 60               AND 60H
0135   00BD CA AB 01            JP Z,L0003
0136   00C0 CB 77               BIT 6,A
0137   00C2 CA FF 06            JP Z,L0011
0138   00C5 CB 6F               BIT 5,A
0139   00C7 CA 7B 10            JP Z,L0012
0140   00CA 21 FD 00            LD HL,00FDH
0141   00CD CD 9F 01            CALL L0009
0142   00D0 CD AE 01            CALL L0010
0143   00D3 FD 7E 09            LD A,(IY+09H)
0144   00D6 FE 80               CP 80H
0145   00D8 28 0F               JR Z,L0013
0146   00DA FE C2       L0017:  CP 0C2H
0147   00DC 11 47 01            LD DE,0147H
0148   00DF 20 03               JR NZ,L0014
0149   00E1 11 35 01            LD DE,0135H
0150   00E4 CD D5 0F    L0014:  CALL L0007
0151   00E7 18 C7               JR L0015
0152   00E9 21 08 01    L0013:  LD HL,0108H
0153   00EC CD 9F 01            CALL L0009
0154   00EF CD AE 01            CALL L0010
0155   00F2 FD 7E 09            LD A,(IY+09H)
0156   00F5 FE 80               CP 80H
0157   00F7 CA 02 00            JP Z,L0016
0158   00FA 18 DE               JR L0017
0159   00FC 00                  NOP
...
0169   0106 00                  NOP
0170   0107 00                  NOP
0171   0108 0A                  LD A,(BC)
0172   0109 00                  NOP
0173   010A A0                  AND B
0174   010B 00                  NOP
0175   010C 00                  NOP
0176   010D 46                  LD B,(HL)
0177   010E 00                  NOP
0178   010F 00                  NOP
0179   0110 00                  NOP
0180   0111 00                  NOP
...
;0240   015A 38 0C 
;0241   015C 01 
0241   015D 18 04            LD BC,0418H
0242   015F CC 03 C1            CALL Z,L0029
0243   0162 05                  DEC B
0244   0163 68          L0020:  LD L,B
0245   0164 01 80 08    L0004:  LD BC,0880H
0246   0167 ED 79       L0030:  OUT (C),A
0247   0169 0C                  INC C
...
0276   01A3 FD E1               POP IY
0277   01A5 01 0B 00            LD BC,000BH
0278   01A8 ED B0               LDIR
0279   01AA C9                  RET
0280   01AB C3 00 00    L0003:  JP L0032
0281   01AE FD 7E 00    L0010:  LD A,(IY+00H)
0282   01B1 E6 FE               AND 0FEH
0283   01B3 28 29               JR Z,L0033
0284   01B5 21 DB 01            LD HL,01DBH
0285   01B8 01 03 00            LD BC,0003H
0286   01BB ED B1               CPIR
0287   01BD 28 27               JR Z,L0034
0288   01BF 3E C1               LD A,0C1H
0289   01C1 FD 77 09    L0036:  LD (IY+09H),A
0290   01C4 3E 05               LD A,05H
0291   01C6 D3 53               OUT (53H),A
0292   01C8 3A 7A 61            LD A,(617AH)
0293   01CB D3 53               OUT (53H),A
0294   01CD 11 80 01            LD DE,0180H
0295   01D0 1B          L0035:  DEC DE
0296   01D1 7A                  LD A,D
0297   01D2 B3                  OR E
0298   01D3 20 FB               JR NZ,L0035
0299   01D5 FD 7E 09            LD A,(IY+09H)
0300   01D8 FE 80               CP 80H
0301   01DA C9                  RET
0302   01DB 0A                  LD A,(BC)
0303   01DC 0E 1E               LD C,1EH
0304   01DE 3D          L0033:  DEC A
0305   01DF 32 5A 61            LD (615AH),A
0306   01E2 3E 80               LD A,80H
0307   01E4 18 DB               JR L0036
0308   01E6 3E 04       L0034:  LD A,04H
0309   01E8 32 5B 61            LD (615BH),A
0310   01EB 3E 0A               LD A,0AH
0311   01ED 32 5C 61            LD (615CH),A
0312   01F0 3E 05               LD A,05H
0313   01F2 D3 53               OUT (53H),A
0314   01F4 3E 66               LD A,66H
0315   01F6 D3 53               OUT (53H),A
0316   01F8 06 03               LD B,03H
0317   01FA 10 FE       L0037:  DJNZ L0037
0318   01FC 3E 10               LD A,10H
0319   01FE D3 51               OUT (51H),A
0320   0200 DB 51               IN A,(51H)
0321   0202 CB 67               BIT 4,A
0322   0204 28 0A               JR Z,L0038
0323   0206 FD CB 00 56         BIT 2,(IY+00H)
0324   020A 28 04               JR Z,L0038
0325   020C 3E C3               LD A,0C3H
0326   020E 18 B1               JR L0036
0327   0210 FD 36 09 00 L0038:  LD (IY+09H),00H
0328   0214 FD 5E 04            LD E,(IY+04H)
0329   0217 FD 56 05            LD D,(IY+05H)
0330   021A FD 7E 06            LD A,(IY+06H)
0331   021D ED 53 66 61         LD (6166H),DE
0332   0221 32 68 61            LD (6168H),A
0333   0224 FD 4E 07            LD C,(IY+07H)
0334   0227 FD 46 08            LD B,(IY+08H)
0335   022A ED 43 69 61         LD (6169H),BC
0336   022E FD 6E 01            LD L,(IY+01H)
0337   0231 FD 66 02            LD H,(IY+02H)
0338   0234 FD 7E 03            LD A,(IY+03H)
0339   0237 32 77 61            LD (6177H),A
0340   023A A7                  AND A
0341   023B 28 26               JR Z,L0039
0342   023D CB 85               RES 0,L
0343   023F CB 83               RES 0,E
0344   0241 CB 81               RES 0,C
0345   0243 ED 53 66 61         LD (6166H),DE
0346   0247 ED 43 69 61         LD (6169H),BC
0347   024B E6 07               AND 07H
0348   024D 5F                  LD E,A
0349   024E 16 FC               LD D,0FCH
0350   0250 01 80 08            LD BC,0880H
0351   0253 ED 59       L0040:  OUT (C),E
0352   0255 7A                  LD A,D
0353   0256 C6 08               ADD A,08H
0354   0258 57                  LD D,A
0355   0259 D3 94               OUT (94H),A
0356   025B AF                  XOR A
0357   025C D3 98               OUT (98H),A
0358   025E D3 9C               OUT (9CH),A
0359   0260 0C                  INC C
0360   0261 10 F0               DJNZ L0040
0361   0263 22 75 61    L0039:  LD (6175H),HL
0362   0266 FD 7E 0A            LD A,(IY+0AH)
0363   0269 A7                  AND A
0364   026A 1F                  RRA
0365   026B 32 5D 61            LD (615DH),A
0366   026E 5F                  LD E,A
0367   026F 1F                  RRA
0368   0270 E6 80               AND 80H
0369   0272 32 5E 61            LD (615EH),A
0370   0275 CD DB 06            CALL L0041
0371   0278 EB                  EX DE,HL
0372   0279 3A 5A 61            LD A,(615AH)
0373   027C CB 7F               BIT 7,A
0374   027E 20 19               JR NZ,L0042
0375   0280 95                  SUB L
0376   0281 CA 07 03            JP Z,L0043
0377   0284 67          L0050:  LD H,A
0378   0285 7D                  LD A,L
0379   0286 A7                  AND A
0380   0287 28 10               JR Z,L0042
0381   0289 32 5A 61            LD (615AH),A
0382   028C 7C                  LD A,H
0383   028D 26 08               LD H,08H
0384   028F CB 7F               BIT 7,A
0385   0291 28 18               JR Z,L0044
0386   0293 26 00               LD H,00H
0387   0295 ED 44               NEG
0388   0297 18 12               JR L0044
0389   0299 AF          L0042:  XOR A
0390   029A 32 5A 61            LD (615AH),A
0391   029D 26 08               LD H,08H
0392   029F 3E 10               LD A,10H
0393   02A1 D3 53               OUT (53H),A
0394   02A3 DB 53               IN A,(53H)
0395   02A5 CB 6F               BIT 5,A
...
0402   02B4 B4                  OR H
0403   02B5 D3 88               OUT (88H),A
0404   02B7 32 79 61            LD (6179H),A
0405   02BA 3E 05       L0048:  LD A,05H
0406   02BC D3 53               OUT (53H),A
0407   02BE 3E E6               LD A,0E6H
0408   02C0 D3 53               OUT (53H),A
0409   02C2 3E 05               LD A,05H
0410   02C4 D3 53               OUT (53H),A
0411   02C6 3E 66               LD A,66H
0412   02C8 D3 53               OUT (53H),A
...
0469   033F D3 51               OUT (51H),A
0470   0341 DB 51               IN A,(51H)
0471   0343 CB 6F               BIT 5,A
...
0481   0356 D3 51               OUT (51H),A
0482   0358 DB 51               IN A,(51H)
0483   035A CB 6F               BIT 5,A
0484   035C 28 E9               JR Z,L0057
0485   035E E9                  JP (HL)
0486   035F DB 52               IN A,(52H)
0487   0361 DB 52               IN A,(52H)
0488   0363 DB 52               IN A,(52H)
0489   0365 DB 52               IN A,(52H)
0490   0367 3E 43               LD A,43H
0491   0369 D3 53               OUT (53H),A
0492   036B 3E D9               LD A,0D9H
0493   036D D3 53               OUT (53H),A
0494   036F 11 14 05            LD DE,0514H
0495   0372 DB 53       L0059:  IN A,(53H)
0496   0374 E6 01               AND 01H
...
0506   0388 ED A2               INI
0507   038A DB 53       L0060:  IN A,(53H)
0508   038C E6 01               AND 01H
0509   038E 28 FA               JR Z,L0060
0510   0390 ED A2               INI
0511   0392 20 F6               JR NZ,L0060
0512   0394 DB 53       L0061:  IN A,(53H)
0513   0396 CB 47               BIT 0,A
0514   0398 28 FA               JR Z,L0061
0515   039A 3E 01               LD A,01H
0516   039C D3 53               OUT (53H),A
0517   039E DB 53               IN A,(53H)
0518   03A0 CB 77               BIT 6,A
...
0531   03BE D3 53               OUT (53H),A
0532   03C0 3E D9               LD A,0D9H
0533   03C2 D3 53               OUT (53H),A
0534   03C4 DB 52               IN A,(52H)
0535   03C6 DB 52               IN A,(52H)
0536   03C8 DB 52               IN A,(52H)
0537   03CA DB 52               IN A,(52H)
...
0544   03DB D3 94               OUT (94H),A
0545   03DD 7B                  LD A,E
0546   03DE D3 98               OUT (98H),A
0547   03E0 7A                  LD A,D
0548   03E1 D3 9C               OUT (9CH),A
0549   03E3 44                  LD B,H
0550   03E4 4D                  LD C,L
...
0561   03FA DB 53       L0067:  IN A,(53H)
0562   03FC E6 01               AND 01H
0563   03FE 28 FA               JR Z,L0067
0564   0400 DB 52               IN A,(52H)
0565   0402 2B                  DEC HL
...
0577   0418 DB 53               IN A,(53H)
0578   041A E6 01               AND 01H
0579   041C 28 F6               JR Z,L0071
0580   041E DB 52               IN A,(52H)
...
0588   042A DB 53       L0070:  IN A,(53H)
0589   042C E6 01               AND 01H
0590   042E 28 FA               JR Z,L0070
0591   0430 DB 52               IN A,(52H)
...
0606   044C D1                  POP DE
0607   044D DB 53       L0074:  IN A,(53H)
0608   044F E6 01               AND 01H
0609   0451 28 FA               JR Z,L0074
0610   0453 DB 52               IN A,(52H)
0611   0455 D3 41               OUT (41H),A
0612   0457 13                  INC DE
0613   0458 7B                  LD A,E
0614   0459 D3 98               OUT (98H),A
0615   045B 7A                  LD A,D
0616   045C D3 9C               OUT (9CH),A
0617   045E 10 03               DJNZ L0075
0618   0460 0D                  DEC C
0619   0461 28 D4               JR Z,L0068
0620   0463 DB 53       L0075:  IN A,(53H)
0621   0465 E6 01               AND 01H
0622   0467 28 FA               JR Z,L0075
0623   0469 DB 52               IN A,(52H)
0624   046B D3 41               OUT (41H),A
0625   046D 10 03               DJNZ L0076
0626   046F 0D                  DEC C
0627   0470 28 C5               JR Z,L0068
0628   0472 DB 53       L0076:  IN A,(53H)
0629   0474 E6 01               AND 01H
0630   0476 28 FA               JR Z,L0076
0631   0478 DB 52               IN A,(52H)
0632   047A D3 40               OUT (40H),A
0633   047C 13                  INC DE
0634   047D 7B                  LD A,E
0635   047E D3 98               OUT (98H),A
0636   0480 7A                  LD A,D
0637   0481 D3 9C               OUT (9CH),A
0638   0483 2B                  DEC HL
0639   0484 2B                  DEC HL
...
0663   04B4 CD DB 06            CALL L0041
0664   04B7 C3 07 03            JP L0043
0665   04BA CD DB 06    L0079:  CALL L0041
0666   04BD C3 99 02            JP L0042
0667   04C0 26 04       L0072:  LD H,04H
0668   04C2 DB 53       L0080:  IN A,(53H)
0669   04C4 CB 47               BIT 0,A
0670   04C6 28 FA               JR Z,L0080
0671   04C8 DB 52               IN A,(52H)
0672   04CA 25                  DEC H
0673   04CB 20 F5               JR NZ,L0080
0674   04CD DB 53       L0081:  IN A,(53H)
0675   04CF CB 47               BIT 0,A
0676   04D1 28 FA               JR Z,L0081
0677   04D3 3E 01               LD A,01H
0678   04D5 D3 53               OUT (53H),A
0679   04D7 DB 53               IN A,(53H)
0680   04D9 CB 77               BIT 6,A
0681   04DB C2 56 05            JP NZ,L0082
0682   04DE 3E 03               LD A,03H
0683   04E0 D3 53               OUT (53H),A
0684   04E2 3E C0               LD A,0C0H
0685   04E4 D3 53               OUT (53H),A
...
0747   0573 CD DB 06    L0108:  CALL L0041
...
0932   06E1 ED B3               OTIR
0933   06E3 01 51 02            LD BC,0251H
0934   06E6 3A 5E 61            LD A,(615EH)
0935   06E9 F6 68               OR 68H
0936   06EB ED B3               OTIR
0937   06ED D3 51               OUT (51H),A
0938   06EF C9                  RET
0939   06F0 04                  INC B
0940   06F1 10 06               DJNZ L0109
0941   06F3 FA 07 96            JP M,L0110
0942   06F6 03                  INC BC
0943   06F7 C0                  RET NZ
0944   06F8 10 05               DJNZ L0011
0945   06FA 00                  NOP
0946   06FB 00                  NOP
0947   06FC 00                  NOP
0948   06FD FA 96 CD            JP M,L0111
0949   0700 B3                  OR E
0950   0701 0E CD               LD C,0CDH
0951   0703 D7                  RST 10H
0952   0704 0E 21               LD C,21H
0953   0706 76                  HALT
0954   0707 07                  RLCA
0955   0708 01 51 07            LD BC,0751H
0956   070B ED B3               OTIR
0957   070D 3E 7F       L0119:  LD A,7FH
0958   070F D3 88               OUT (88H),A
0959   0711 11 16 08            LD DE,0816H
0960   0714 CD D5 0F            CALL L0007
...
1002   0776 18 04               JR L0126
1003   0778 CC 05 68            CALL Z,L0127
1004   077B 03                  INC BC
1005   077C C1          L0126:  POP BC
...
1034   07B6 CD D5 0F            CALL L0007
1035   07B9 CD E8 07            CALL L0136
1036   07BC 3E 7F               LD A,7FH
1037   07BE D3 88               OUT (88H),A
1038   07C0 C9                  RET
1039   07C1 D1                  POP DE
1040   07C2 08                  EX AF,AF'
1041   07C3 DC 08 E6            CALL C,L0137
1042   07C6 08                  EX AF,AF'
1043   07C7 F7                  RST 30H
1044   07C8 08                  EX AF,AF'
1045   07C9 08                  EX AF,AF'
1046   07CA 09                  ADD HL,BC
1047   07CB 08                  EX AF,AF'
1048   07CC 09                  ADD HL,BC
1049   07CD 0A                  LD A,(BC)
1050   07CE 09                  ADD HL,BC
1051   07CF 1B                  DEC DE
1052   07D0 09                  ADD HL,BC
1053   07D1 2D                  DEC L
1054   07D2 09                  ADD HL,BC
1055   07D3 3F                  CCF
1056   07D4 09                  ADD HL,BC
...
1062   07E5 CD D5 0F    L0138:  CALL L0007
1063   07E8 11 98 08    L0136:  LD DE,0898H
1064   07EB CD D5 0F            CALL L0007
...
1347   0950 FD               CP 0FDH
1348   0951 CB 00               RLC B
1349   0953 4E                  LD C,(HL)
1350   0954 C2 38 0D            JP NZ,L0165
1351   0957 C3 E6 0B            JP L0166
1352   095A FD CB 00 4E         BIT 1,(IY+00H)
1353   095E C2 2A 0D            JP NZ,L0167
1354   0961 C3 49 0C            JP L0168
1355   0964 FD CB 00 4E         BIT 1,(IY+00H)
...
1482   0A7D CD F3 0A    L0177:  CALL L0182
...
1551   0AFB 6F                  LD L,A
1552   0AFC ED 69       L0194:  OUT (C),L
1553   0AFE 7C                  LD A,H
1554   0AFF D3 94               OUT (94H),A
1555   0B01 C6 08               ADD A,08H
1556   0B03 67                  LD H,A
1557   0B04 AF                  XOR A
1558   0B05 D3 9C               OUT (9CH),A
1559   0B07 0C                  INC C
1560   0B08 10 F2               DJNZ L0194
1561   0B0A 3E 07               LD A,07H
1562   0B0C D3 94               OUT (94H),A
1563   0B0E C9                  RET
...
1761   0C88 C9                  RET
1762   0C89 04                  INC B
1763   0C8A 11 06 9D            LD DE,9D06H
1764   0C8D 07                  RLCA
1765   0C8E 65                  LD H,L
1766   0C8F 05                  DEC B
1767   0C90 E0                  RET PO
...
2216   0FAC FD E1               POP IY
2217   0FAE 01 0B 00            LD BC,000BH
2218   0FB1 ED B0               LDIR
2219   0FB3 C9                  RET
2220   0FB4 0E 00               LD C,00H
2221   0FB6 6F                  LD L,A
2222   0FB7 00                  NOP
2223   0FB8 00                  NOP
2224   0FB9 9A                  SBC A,D
2225   0FBA 00                  NOP
2226   0FBB 00                  NOP
2227   0FBC 00                  NOP
2228   0FBD 00                  NOP
2229   0FBE 0C                  INC C
2230   0FBF 0E 30               LD C,30H
2231   0FC1 6B                  LD L,E
2232   0FC2 00                  NOP
2233   0FC3 00                  NOP
2234   0FC4 0E 00               LD C,00H
2235   0FC6 00                  NOP
2236   0FC7 00                  NOP
2237   0FC8 00                  NOP
2238   0FC9 17                  RLA
2239   0FCA 0E 00               LD C,00H
2240   0FCC 00                  NOP
2241   0FCD 80                  ADD A,B
2242   0FCE 00                  NOP
2243   0FCF 00                  NOP
2244   0FD0 01 00 00            LD BC,0000H
2245   0FD3 00                  NOP
2246   0FD4 18 1A               JR L0278
2247   0FD6 13                  INC DE
2248   0FD7 FE FE               CP 0FEH
2249   0FD9 C8                  RET Z
2250   0FDA 47                  LD B,A
2251   0FDB E6 60               AND 60H
2252   0FDD 78                  LD A,B
2253   0FDE 20 05               JR NZ,L0279
2254   0FE0 CD EA 0F            CALL L0280
2255   0FE3 18 F0               JR L0007
2256   0FE5 CD 71 10    L0279:  CALL L0281
2257   0FE8 18 EB               JR L0007
2258   0FEA FE 10       L0280:  CP 10H
2259   0FEC 28 75               JR Z,L0282
2260   0FEE FE 17               CP 17H
2261   0FF0 28 16       L0278:  JR Z,L0283
2262   0FF2 FE 18               CP 18H
2263   0FF4 28 17               JR Z,L0284
2264   0FF6 FE 19               CP 19H
2265   0FF8 28 23               JR Z,L0285
2266   0FFA FE 15               CP 15H
2267   0FFC 28 4A               JR Z,L0286
2268   0FFE FE 90               CP 90H
2269   1000 38 63               JR C,L0005
2270   1002 E6 0F               AND 0FH
2271   1004 F6 C0               OR 0C0H
2272   1006 18 5D               JR L0005
2273   1008 CD 40 10    L0283:  CALL L0287
2274   100B 18 62               JR L0288
2275   100D CD 40 10    L0284:  CALL L0287
2276   1010 2E 0A               LD L,0AH
2277   1012 CD 38 10            CALL L0289
2278   1015 F5                  PUSH AF
2279   1016 78                  LD A,B
2280   1017 CD 6F 10            CALL L0288
2281   101A F1                  POP AF
2282   101B 18 52               JR L0288
2283   101D CD 40 10    L0285:  CALL L0287
2284   1020 2E 64               LD L,64H
2285   1022 CD 38 10            CALL L0289
2286   1025 F5                  PUSH AF
2287   1026 78                  LD A,B
2288   1027 CD 6F 10            CALL L0288
2289   102A F1                  POP AF
2290   102B 2E 0A               LD L,0AH
2291   102D CD 38 10            CALL L0289
2292   1030 F5                  PUSH AF
2293   1031 78                  LD A,B
2294   1032 CD 6F 10            CALL L0288
2295   1035 F1                  POP AF
2296   1036 18 37               JR L0288
...
2327   1061 18 0C       L0293:  JR L0288
2328   1063 3E 01       L0282:  LD A,01H
2329   1065 0E A2       L0005:  LD C,0A2H
2330   1067 ED 70       L0294:  IN (C)
2331   1069 FA 67 10            JP M,L0294
2332   106C D3 A0               OUT (0A0H),A
2333   106E C9                  RET
2334   106F C6 30       L0288:  ADD A,30H
2335   1071 0E A2       L0281:  LD C,0A2H
2336   1073 ED 70       L0295:  IN (C)
...
2379   10CE 11 22 11            LD DE,1122H
...
2388   10E0 11 07 11            LD DE,1107H
2389   10E3 CD D5 0F    L0313:  CALL L0007
2390   10E6 3E 7D               LD A,7DH
2391   10E8 D3 88               OUT (88H),A
2392   10EA CD 56 15    L0316:  CALL L0315
...
2450   1136 FD
2451   1137 21 00 00            LD HL,0000H
...
2464   1152 CD D5 0F            CALL L0007
2465   1155 DB 58               IN A,(58H)
2466   1157 CB 77               BIT 6,A
2467   1159 C8                  RET Z
2468   115A CB 6F               BIT 5,A
2469   115C 20 F7               JR NZ,L0326
2470   115E CD 70 15            CALL L0327
2471   1161 DB 58               IN A,(58H)
2472   1163 CB 6F               BIT 5,A
2473   1165 28 FA       L0319:  JR Z,L0328
2474   1167 CD 70 15            CALL L0327
2475   116A F1                  POP AF
...
2733   1306 11
2734   1307 74                  LD (HL),H
2735   1308 13                  INC DE
2736   1309 CD D5 0F            CALL L0007
2737   130C 0E 08               LD C,08H
2738   130E 3E 78               LD A,78H
2739   1310 0D                  DEC C
2740   1311 B1                  OR C
...
2790   135A CD D5 0F            CALL L0007
2791   135D D1                  POP DE
2792   135E CD D5 0F            CALL L0007
...
3194   154B 79                  LD A,C
3195   154C 15                  DEC D
3196   154D CD D5 0F            CALL L0007
3197   1550 CD 56 15    L0394:  CALL L0315
3198   1553 C0                  RET NZ
...
3221   1578 C9                  RET
3222   1579 80                  ADD A,B
3223   157A FF                  RST 38H
3224   157B FF                  RST 38H
3225   157C FF                  RST 38H
3226   157D FF                  RST 38H
3227   157E FF                  RST 38H
3228   157F FF                  RST 38H
3229   1580 FF                  RST 38H
3230   1581 FF                  RST 38H
3231   1582 FF                  RST 38H
3232   1583 FF                  RST 38H
3233   1584 FF                  RST 38H
3234   1585 FF                  RST 38H
3235   1586 FF                  RST 38H
3236   1587 FF                  RST 38H
3237   1588 FF                  RST 38H
3238   1589 FF                  RST 38H
3239   158A 90                  SUB B
3240   158B FF                  RST 38H
3241   158C FF                  RST 38H
3242   158D FF                  RST 38H
3243   158E FF                  RST 38H
3244   158F FF                  RST 38H
3245   1590 FF                  RST 38H
3246   1591 FF                  RST 38H
3247   1592 FF                  RST 38H
3248   1593 FF                  RST 38H
3249   1594 FF                  RST 38H
3250   1595 FF                  RST 38H
3251   1596 FF                  RST 38H
3252   1597 FF                  RST 38H
3253   1598 FF                  RST 38H
3254   1599 FF                  RST 38H
3255   159A FF                  RST 38H
3256   159B FE 11               CP 11H
3257   159D C0                  RET NZ
3258   159E 15                  DEC D
3259   159F CD D5 0F            CALL L0007
...
3303   15E0 3E
3304   15E1 FF                  RST 38H
3305   15E2 D3 8C               OUT (8CH),A
3306   15E4 D3 90               OUT (90H),A
3307   15E6 21 1A 68            LD HL,681AH
3308   15E9 11 1B 68            LD DE,681BH
3309   15EC 01 0F 00            LD BC,000FH
3310   15EF 36 00               LD (HL),00H
3311   15F1 ED B0               LDIR
3312   15F3 11 28 16    L0407:  LD DE,1628H
3313   15F6 CD D5 0F            CALL L0007
3314   15F9 CD 56 15            CALL L0315
3315   15FC C0                  RET NZ
3316   15FD 06 08               LD B,08H
3317   15FF 78          L0406:  LD A,B
3318   1600 3D                  DEC A
3319   1601 D3 C0               OUT (0C0H),A
3320   1603 CD 6B 15            CALL L0404
3321   1606 DB C0               IN A,(0C0H)
3322   1608 58                  LD E,B
3323   1609 1D                  DEC E
3324   160A 37                  SCF
3325   160B CB 13               RL E
...
3344   1628 80                  ADD A,B
3345   1629 19                  ADD HL,DE
3346   162A 1A          L0423:  LD A,(DE)
3347   162B 68                  LD L,B
3348   162C 20 19               JR NZ,L0408
3349   162E 1E 68               LD E,68H
3350   1630 20 19               JR NZ,L0303
3351   1632 22 68 20            LD (2068H),HL
3352   1635 19                  ADD HL,DE
3353   1636 26 68               LD H,68H
3354   1638 20 90               JR NZ,L0409
3355   163A 20 19               JR NZ,L0410
3356   163C 1C                  INC E
3357   163D 68                  LD L,B
3358   163E 20 19               JR NZ,L0411
3359   1640 20 68               JR NZ,L0412
3360   1642 20 19               JR NZ,L0413
3361   1644 24                  INC H
3362   1645 68                  LD L,B
3363   1646 20 19               JR NZ,L0414
3364   1648 28 68               JR Z,L0415
3365   164A FE 11               CP 11H
3366   164C 88                  ADC A,B
3367   164D 16 CD       L0402:  LD D,0CDH
3368   164F D5                  PUSH DE
3369   1650 0F                  RRCA
3370   1651 11 A1 16    L0418:  LD DE,16A1H
3371   1654 CD D5 0F            CALL L0007
...
3416   16A1 96                  SUB (HL)
3417   16A2 15                  DEC D
3418   16A3 FE 18               CP 18H
3419   16A5 04                  INC B
3420   16A6 CC 05 68            CALL Z,L0127
3421   16A9 03                  INC BC
3422   16AA C1          L0412:  POP BC
3423   16AB 11 EC 16    L0304:  LD DE,16ECH
3424   16AE CD D5 0F            CALL L0007
3425   16B1 CD 56 15    L0425:  CALL L0315
3426   16B4 28 FB               JR Z,L0425
3427   16B6 21 A4 16            LD HL,16A4H
3428   16B9 01 51 07            LD BC,0751H
3429   16BC ED B3               OTIR
...
3444   16D7 CD D5 0F            CALL L0007
3445   16DA 18 06               JR L0429
3446   16DC 11 25 17    L0426:  LD DE,1725H
3447   16DF CD D5 0F            CALL L0007
3448   16E2 CD 56 15            CALL L0315
...
3627   1808 B7                  OR A
3628   1809 C9                  RET
3629   180A 18 18               JR L0459
3630   180C 18 01               JR L0460
3631   180E 04                  INC B
3632   180F 04          L0460:  INC B
3633   1810 00                  NOP
3634   1811 06 5A               LD B,5AH
3635   1813 07                  RLCA
3636   1814 5A                  LD E,D
3637   1815 05                  DEC B
3638   1816 E8                  RET PE
...
3740   1893 11
3741   1894 02                  LD (BC),A
3742   1895 19                  ADD HL,DE
3743   1896 CD D5 0F            CALL L0007
3744   1899 3E 78       L0476:  LD A,78H
3745   189B CD B2 18            CALL L0474
3746   189E 20 1B               JR NZ,L0475
3747   18A0 EB                  EX DE,HL
3748   18A1 3E 79               LD A,79H
3749   18A3 CD B2 18            CALL L0474
3750   18A6 20 13               JR NZ,L0475
3751   18A8 3E 7D               LD A,7DH
3752   18AA CD B2 18            CALL L0474
3753   18AD C2 56 15            JP NZ,L0315
3754   18B0 18 E7       L0471:  JR L0476
3755   18B2 D3 88       L0474:  OUT (88H),A
3756   18B4 CD F9 18            CALL L0477
...
3765   18C6 D3 C0               OUT (0C0H),A
3766   18C8 CD F9 18            CALL L0477
3767   18CB DB C0               IN A,(0C0H)
...
3783   18E7 CD D5 0F            CALL L0007
3784   18EA DB 58       L0481:  IN A,(58H)
3785   18EC 3C                  INC A
3786   18ED 20 FB               JR NZ,L0481
3787   18EF CD F9 18            CALL L0477
...
3841   194D CD 70 15            CALL L0327
3842   1950 DB 58               IN A,(58H)
...
4135   1B20 0E 94               LD C,94H
4136   1B22 71                  LD (HL),C
4137   1B23 00                  NOP
4138   1B24 00                  NOP
4139   1B25 0E 00               LD C,00H
